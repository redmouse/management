...
CREATE TABLE `wk005` (
  ...
  PRIMARY KEY (`tradeId`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='求人事業者情報';
...
INSERT INTO `wk005` VALUES (1,'三洋会社','新宿','小田','小田','特にない'),(14,'日立製作','大阪','','',''),(15,'松本','九州','','',''),(16,'三菱会社','新宿','川田','',''),(17,'三菱会社','222','小田','',''),(18,'松下','大阪','涼','涼',''),(19,'会社名','222','小田','川田','テスト'),(20,'日立会社','渋谷','太郎','次郎','');
...
-- Dump completed on 2013-12-29 20:10:39
