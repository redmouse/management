...
<form id="form1" name="form1" method="post" action="">
  	...
  	<table border="1" align=center>
    	...
    	<c:forEach items="${disp003List}" var="disp003Bean">
    		  <tr>
			    ...
			    <td><fmt:setLocale value="ja_JP" /><fmt:formatNumber value="${disp003Bean.wk004Bean.dispFee}" type="CURRENCY" groupingUsed="true" /></td>
	...
	<table border="1" align="center">
    	<tr>
      		<th>合計金額：　</th>
      		<td border="1"><fmt:setLocale value="ja_JP" /><fmt:formatNumber value="${total}" type="CURRENCY" groupingUsed="true" /> 円</td>
    	</tr>
	</table><br />
 	　
